...
<html lang="zxx">
<head>
<title>shiksha an Education Category Bootstrap Responsive Website Template | Home :: w3layouts</title>
<!-- Meta tag Keywords -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="shiksha web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
...
<div class="main_section_agile" id="home">
	<div class="agileits_w3layouts_banner_nav">
		<nav class="navbar navbar-default">
			...
			<h1><a class="navbar-brand" href="index.html"><i class="fa fa-leanpub" aria-hidden="true"></i> shiksha</a></h1>
		 ...
		 <div class="w3l-form">
			...
			<div class="contact-grid1">
                ...
                if(isset($_POST['register'])) {
                    ...
                    $sql_query="insert into listtbl(fname,lname,emailid,mobile,message,insertdatetime) values('$fname','$lname','$emailid','$mobile','$message','$currentdatetime')";
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-2">
                                    ...
                                    <input id="fname" type="text" name="fname" class="form-control" placeholder="Full Name" required="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-2">
                                    <label for="form_lastname">Subject Name<span class="text-danger">*</span></label>
                                    <input id="lname" type="text" name="lname" class="form-control" placeholder="Subject Name" required="">
                                </div>
                            </div>
                        </div>
                        <div class="row">
...
<div class="w3layouts_copy_right">
	<div class="container">
		<p>© <?php echo $general_fetch['website_start']; ?> - 2018 shiksha. All rights reserved | Design by <a href="http://w3layouts.com">lovewebdev</a> Developed By Prem Kunjir Official</p>
	</div>
</div>
	<?php } else{ ?>
...
<div class="w3layouts_copy_right">
	<div class="container">
		<p>© <?php echo $general_fetch['website_start']; ?> - 2018 shiksha. All rights reserved | Design by <a href="http://w3layouts.com">W3layouts.</a> Developed By Ravi Khadka</p>
	</div>
</div>
	<?php }?>
	<!-- //footer -->
